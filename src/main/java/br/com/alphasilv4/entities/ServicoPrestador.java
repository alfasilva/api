...
@NamedQueries({
    ...
    @NamedQuery(name = "ServicoPrestador.findByServicoAndPrestador", query = "SELECT s FROM ServicoPrestador s WHERE (s.servico = :servico) and (s.prestador = :prestador)")}
)
...
public class ServicoPrestador implements Serializable {
    ...
    public ServicoPrestador(Integer id) {
        this.id = id;
    }

    public ServicoPrestador(Integer id, long valor, Date dataIni) {
        this.id = id;
        this.valor = valor;
    ...
    public String toString() {
        return "br.com.alphasilv4.entities.ServicoPrestador[ id=" + id + " ]";
    }

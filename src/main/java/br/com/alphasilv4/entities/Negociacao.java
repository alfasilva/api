...
public class Negociacao implements Serializable {
    ...
    public Negociacao(Integer id, Date dataIni) {
        this.id = id;
    ...
    public Negociacao(Integer id, Date dataIni, Date dataFim, Profile cliente, Profile prestador) {
        this.id = id;
        this.dataIni = dataIni;
    ...
    public String toString() {
        return "br.com.alphasilv4.entities.Negociacao[ id=" + id + " ]";
    }

...
public class LoginAPI implements Serializable {
    ...
    public List<Account> getAll() {
        ...
        System.out.println("login GET -> getALL");
        List<Account> retorno = new ArrayList<>();
        try {
    ...
    public Account findById(@PathParam("id") Long id) {
        ...
        System.out.println("login GET -> findById");
    ...
    public Account findByEmail(@PathParam("email") String email) {
        ...
        System.out.println("login GET -> findByEmail");
        Account login1 = null;
        try {
            login1 = new Account("joao", "joao@marte.com.br", "12343");
    ...
    public void update(@PathParam("id") Long id, Account login) {
        ...
        System.out.println("login PUT -> update");
    ...
    public Account create(Account login) {
        ...
        System.out.println("login POST -> create");
